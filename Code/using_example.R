...
#### A guide to use alpha_PDI, genfun, and wcfun functions
#    Use the functions as you please
...
## 1.3. Load your data set or create your own in R
...
## Resource abundance distribution must be imported as a vector.
...
## Use alpha_PDI with the argument "corrected = F" to calculate 
## the raw version of the index
