...
spen<-lseq(0.01, 70, length =200)#Specialization parameter
...
if (TRUE){
  ...
  boxplot(error1, ylim=c(-1,1), pch=8)
  points(x=x_xit, y=c(error1$R5,error1$R10,error1$R50),
         bg= alpha(spar_col,0.3), pch=21, col=alpha("black",0.3), cex=0.8)
  spar_col<-colorin(lisExv$aPDI)
  msqe<-round(apply(as.matrix(error1), 2, msqerrorfun),2)
  text(x=1, y=1, labels=bquote("MSE = "*.(msqe[1])))
  text(x=2, y=1, labels=bquote("MSE = "*.(msqe[2])))
  text(x=3, y=1, labels=bquote("MSE = "*.(msqe[3])))
  abline(h=0, lty=2)
  ...
  boxplot(errorBS, ylim=c(-1,1), pch=8)
  ...
  boxplot(errorBprime, ylim=c(-1,1), pch=8)
  ...
  boxplot(errorW, ylim=c(-1,1), pch=8)
  ...
  boxplot(errorPS, ylim=c(-1,1),  pch=8)
  ...
  boxplot(errorFT, ylim=c(-1,1),pch=8)
  ...
  boxplot(errord, ylim=c(-1,1), pch=8)
  ...
  boxplot(errorgen, ylim=c(-1,1), pch=8)
...
boxplot(errorWc, ylim=c(-1,1), pch=8)
spar_col<-colorin(lisExvwc)
points(x=x_xit, y=c(errorWc$R5,errorWc$R10,errorWc$R50),
       bg= alpha(spar_col,0.5), pch=21, col=alpha("black",0.6), cex=0.8)
...
plot(y=c(0,2),x=c(0,1),type = 'n', axes = F,xlab = '', ylab = '', 
     cex.main=2.2 ,main = expression("Specialization parameter"))
text(x=seq(0,1,l=3), y =1.5 , labels = c(0.1,"",60), cex=1.5)
