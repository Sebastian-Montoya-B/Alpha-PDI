...
2. Data (folder) -> folder containing the theoretical data used for the analyses and figures. Data were generated using the "quantitative niche model" of Fründ et al. (2016).
   ...
   * samp_vectors_even.RDS -> list of vectors of resource use for 3600 consumers. Vectors were generated using a variable number of potential resources (5, 10, and 50), with the specialization parameter varying from low (0.5) to high (60), even resource abundance distributions, and a random trait matching.
   * samp_vectors_uneven.RDS -> list of vectors of resource use for 3600 consumers. Vectors were generated using a variable number of potential resources (5, 10, and 50), with the specialization parameter varying from low (0.5) to high (60), uneven resource abundance distributions, and a random trait matching.
